...
class StopModel(Base):
    ...
    latitude: Mapped[float] = mapped_column(Double)
    longitude: Mapped[float] = mapped_column(Double)
    arrival_radius_m: Mapped[int] = mapped_column(Integer, default=100)
...
class RoutePretripGuidanceModel(Base):
    ...
    introduction_transcript_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    introduction_script_version: Mapped[str | None] = mapped_column(String(40), nullable=True)
...
class RoutePredepartureTrackModel(Base):
...
class TriggerRegionModel(Base):
    ...
    latitude: Mapped[float] = mapped_column(Double)
    longitude: Mapped[float] = mapped_column(Double)
    entry_radius_m: Mapped[int] = mapped_column(Integer, default=100)
    exit_radius_m: Mapped[int] = mapped_column(Integer, default=150)
