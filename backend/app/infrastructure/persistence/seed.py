...
SHENZHEN_STOPS = [
    ...
    },
    {
        ...
        "title": "报德广场",
        "kicker": "广场里的公共生活",
        "experience_tags": ["公共空间", "城市生活", "适合停留"],
        "address": "南头古城报德广场附近",
        "latitude": 22.53960,
        "longitude": 113.92293,
    ...
    },
    {
        ...
        "title": "中山南街",
        "kicker": "旧街巷里的新用途",
        "experience_tags": ["城市更新", "老街漫步", "新旧共生"],
    ...
    },
    {
        ...
        "title": "北街口",
        "kicker": "回望一座仍在生长的古城",
        "experience_tags": ["城市更新", "生活街区", "适合拍照"],
    ...
    *,
    ...
    for item in stops:
        ...
        stop = StopModel(
            ...
            experience_tags_json=item.get("experience_tags", []),
        )
