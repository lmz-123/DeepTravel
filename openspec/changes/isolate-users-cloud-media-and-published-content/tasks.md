...
- [x] 7.5 Commit and push backend/client/OpenSpec changes to `main` in the DeepTravel repository, commit and push admin changes to its `main`, and deliver the verified APK plus idempotent server pull/migrate/restart/health-check commands.
